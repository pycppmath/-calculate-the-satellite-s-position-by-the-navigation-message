function [Xs,Ys,Zs]=readatandcomp(file,PRNwanted,tob,t)
...
[Xs,Ys,Zs]=comsatpos(t,toc,a0,a1,a2,Crs,Delta_n,M0,Cuc,e,Cus,sqrtA,toe,Cic,OMEGA,Cis,i0,Crc,omega,OMEGA_DOT,iDOT);
end
